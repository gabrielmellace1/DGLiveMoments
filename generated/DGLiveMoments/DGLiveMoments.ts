...
export class BurnedNFT extends ethereum.Event {
  get params(): BurnedNFT__Params {
    return new BurnedNFT__Params(this);
  }
}

export class BurnedNFT__Params {
  _event: BurnedNFT;

  constructor(event: BurnedNFT) {
    this._event = event;
  }
...
export class DGLiveMoments__royaltyInfoResult {
  value0: Address;
  value1: BigInt;
...
export class DGLiveMoments extends ethereum.SmartContract {
  static bind(address: Address): DGLiveMoments {
    return new DGLiveMoments("DGLiveMoments", address);
  }
  ...
  royaltyInfo(
    tokenId: BigInt,
    salePrice: BigInt
  ): DGLiveMoments__royaltyInfoResult {
    let result = super.call(
      "royaltyInfo",
    ...
    return new DGLiveMoments__royaltyInfoResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_royaltyInfo(
    tokenId: BigInt,
    salePrice: BigInt
  ): ethereum.CallResult<DGLiveMoments__royaltyInfoResult> {
    let result = super.tryCall(
      "royaltyInfo",
      "royaltyInfo(uint256,uint256):(address,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new DGLiveMoments__royaltyInfoResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
